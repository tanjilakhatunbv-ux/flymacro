...
const CODE_TO_I18N_KEY: Record<string, string> = {
  ...
  missing_redeem_code: 'apiErrors.missing_redeem_code',
  redeem_code_not_found: 'apiErrors.redeem_code_not_found',
  redeem_code_disabled: 'apiErrors.redeem_code_disabled',
  redeem_code_exhausted: 'apiErrors.redeem_code_exhausted',
  redeem_code_failed: 'apiErrors.redeem_code_failed',
