  ...
  fields: [
    {
      ...
      options: [
        ...
        { label: '宏兑换', value: 'exchange' },
        { label: '宏续费', value: 'renew' },
        { label: '领取奖励', value: 'claim_bonus' },
        { label: '支付到账', value: 'payment_received' },
        { label: 'OAuth登录', value: 'oauth_login' },
        { label: '自动续费', value: 'auto_renew' },
